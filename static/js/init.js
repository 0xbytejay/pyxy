(function( $ ){
  ...
  $(document).ready(function(){
    ...
    $('#header').vegas({
      slides: [
        { src: "static/images/slide_img01.jpg" },
        { src: "static/images/slide_img02.jpg" },
        { src: "static/images/slide_img03.jpg" }
      ]
    });
    ...
    function initialize() {
      ...
      var contentString = '<div class="address-box">'
        + '<div class="info-head"><img src="static/images/logo_dark.png" alt=""></div>'
        + '<p class="map-address">'
      ...
      var image   = 'static/images/locate.png';
